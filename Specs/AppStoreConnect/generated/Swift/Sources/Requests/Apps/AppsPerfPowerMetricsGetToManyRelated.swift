...
extension AppStoreConnect.Apps {
    ...
    public enum AppsPerfPowerMetricsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-perfPowerMetrics-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/perfPowerMetrics", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
