...
extension Rocket.Profile {
    ...
    public enum GetWatched {
        ...
        public static let service = APIService<Response>(id: "getWatched", tag: "profile", method: "GET", path: "/account/profile/watched", hasBody: false, securityRequirements: [SecurityRequirement(type: "profileAuth", isRequired: true, scopes: ["Catalog"])])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetWatched.service)
            }
        }

        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = [String: Watched]

            /** OK */
            case status200([String: Watched])
            ...
            public var success: [String: Watched]? {
                switch self {
            ...
            public var responseResult: APIResponseResult<[String: Watched], ServiceError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([String: Watched].self, from: data))
