...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaLicenseAgreementGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "apps-betaLicenseAgreement-get_to_one_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/betaLicenseAgreement", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaLicenseAgreements: [FieldsbetaLicenseAgreements]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaLicenseAgreements: [FieldsbetaLicenseAgreements]? = nil) {
