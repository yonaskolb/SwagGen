...
extension AppStoreConnect.IdfaDeclarations {
    ...
    public enum IdfaDeclarationsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "idfaDeclarations-delete_instance", tag: "IdfaDeclarations", method: "DELETE", path: "/v1/idfaDeclarations/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
