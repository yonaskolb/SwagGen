...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-get_instance", tag: "AppInfoLocalizations", method: "GET", path: "/v1/appInfoLocalizations/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
