...
extension TVDB.Users {
    ...
    public enum DeleteUserFavoritesById {

        public static let service = APIService<Response>(id: "deleteUserFavoritesById", tag: "Users", method: "DELETE", path: "/user/favorites/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "jwtToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteUserFavoritesById.service)
            }
