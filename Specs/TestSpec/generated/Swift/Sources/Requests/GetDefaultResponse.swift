...
extension TestSpec {
    ...
    public enum GetDefaultResponse {
        ...
        public static let service = APIService<Response>(id: "getDefaultResponse", tag: "", method: "GET", path: "/default-response", hasBody: false, securityRequirements: [SecurityRequirement(type: "test_auth", isRequired: true, scopes: ["read"])])
