...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-get_instance", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
