...
extension AppStoreConnect.AppCategories {
    ...
    public enum AppCategoriesSubcategoriesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appCategories-subcategories-get_to_many_related", tag: "AppCategories", method: "GET", path: "/v1/appCategories/{id}/subcategories", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
