...
extension AppStoreConnect.AppPricePoints {
    ...
    public enum AppPricePointsGetCollection {
        ...
        public static let service = APIService<Response>(id: "appPricePoints-get_collection", tag: "AppPricePoints", method: "GET", path: "/v1/appPricePoints", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
