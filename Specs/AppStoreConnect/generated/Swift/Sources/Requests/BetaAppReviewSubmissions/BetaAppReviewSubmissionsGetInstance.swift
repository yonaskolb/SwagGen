...
extension AppStoreConnect.BetaAppReviewSubmissions {
    ...
    public enum BetaAppReviewSubmissionsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewSubmissions-get_instance", tag: "BetaAppReviewSubmissions", method: "GET", path: "/v1/betaAppReviewSubmissions/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewSubmissions: [FieldsbetaAppReviewSubmissions]? = nil, include: [Include]? = nil, fieldsbuilds: [Fieldsbuilds]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaAppReviewSubmissions: [FieldsbetaAppReviewSubmissions]? = nil, include: [Include]? = nil, fieldsbuilds: [Fieldsbuilds]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BetaAppReviewSubmissionResponse

            /** Single BetaAppReviewSubmission */
            case status200(BetaAppReviewSubmissionResponse)
            ...
            public var success: BetaAppReviewSubmissionResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BetaAppReviewSubmissionResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BetaAppReviewSubmissionResponse.self, from: data))
