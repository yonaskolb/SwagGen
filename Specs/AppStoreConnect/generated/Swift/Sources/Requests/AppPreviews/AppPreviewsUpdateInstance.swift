...
extension AppStoreConnect.AppPreviews {
    ...
    public enum AppPreviewsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviews-update_instance", tag: "AppPreviews", method: "PATCH", path: "/v1/appPreviews/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
