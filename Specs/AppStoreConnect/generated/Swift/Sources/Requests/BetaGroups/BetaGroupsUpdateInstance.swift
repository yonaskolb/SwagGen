...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "betaGroups-update_instance", tag: "BetaGroups", method: "PATCH", path: "/v1/betaGroups/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BetaGroupUpdateRequest

            public init(body: BetaGroupUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: BetaGroupUpdateRequest) {
