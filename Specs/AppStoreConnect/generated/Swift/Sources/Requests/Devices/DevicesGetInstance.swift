...
extension AppStoreConnect.Devices {
    ...
    public enum DevicesGetInstance {
        ...
        public static let service = APIService<Response>(id: "devices-get_instance", tag: "Devices", method: "GET", path: "/v1/devices/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsdevices: [Fieldsdevices]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsdevices: [Fieldsdevices]? = nil) {
