...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsProfilesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "bundleIds-profiles-get_to_many_related", tag: "BundleIds", method: "GET", path: "/v1/bundleIds/{id}/profiles", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsprofiles: [Fieldsprofiles]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsprofiles: [Fieldsprofiles]? = nil, limit: Int? = nil) {
