...
extension TestSpec {
    ...
    public enum GetMultipleSuccess {
        ...
        public static let service = APIService<Response>(id: "getMultipleSuccess", tag: "", method: "GET", path: "/multiple-success", hasBody: false, securityRequirements: [SecurityRequirement(type: "test_auth", isRequired: true, scopes: ["write"])])
