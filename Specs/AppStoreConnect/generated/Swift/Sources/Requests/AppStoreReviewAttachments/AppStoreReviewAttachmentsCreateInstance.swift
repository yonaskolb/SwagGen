...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-create_instance", tag: "AppStoreReviewAttachments", method: "POST", path: "/v1/appStoreReviewAttachments", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
