...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-delete_instance", tag: "BundleIds", method: "DELETE", path: "/v1/bundleIds/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
