...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-create_instance", tag: "AppScreenshotSets", method: "POST", path: "/v1/appScreenshotSets", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
