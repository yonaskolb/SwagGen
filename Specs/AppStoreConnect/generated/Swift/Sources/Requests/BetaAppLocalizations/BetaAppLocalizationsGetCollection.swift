...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaAppLocalizations-get_collection", tag: "BetaAppLocalizations", method: "GET", path: "/v1/betaAppLocalizations", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(filterlocale: [String]? = nil, filterapp: [String]? = nil, fieldsbetaAppLocalizations: [FieldsbetaAppLocalizations]? = nil, limit: Int? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
