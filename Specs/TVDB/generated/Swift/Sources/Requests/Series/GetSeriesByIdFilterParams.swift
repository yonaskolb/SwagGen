...
extension TVDB.Series {
    ...
    public enum GetSeriesByIdFilterParams {

        public static let service = APIService<Response>(id: "getSeriesByIdFilterParams", tag: "Series", method: "GET", path: "/series/{id}/filter/params", hasBody: false, securityRequirement: SecurityRequirement(type: "jwtToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSeriesByIdFilterParams.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = FilterKeys

            /** A list of keys to filter by */
            case status200(FilterKeys)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(FilterKeys.self, from: data))
