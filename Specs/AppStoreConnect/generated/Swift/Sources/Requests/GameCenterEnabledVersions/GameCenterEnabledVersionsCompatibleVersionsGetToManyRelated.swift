...
extension AppStoreConnect.GameCenterEnabledVersions {
    ...
    public enum GameCenterEnabledVersionsCompatibleVersionsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "gameCenterEnabledVersions-compatibleVersions-get_to_many_related", tag: "GameCenterEnabledVersions", method: "GET", path: "/v1/gameCenterEnabledVersions/{id}/compatibleVersions", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, filterplatform: [Filterplatform]? = nil, filterversionString: [String]? = nil, filterapp: [String]? = nil, filterid: [String]? = nil, sort: [Sort]? = nil, fieldsgameCenterEnabledVersions: [FieldsgameCenterEnabledVersions]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, filterplatform: [Filterplatform]? = nil, filterversionString: [String]? = nil, filterapp: [String]? = nil, filterid: [String]? = nil, sort: [Sort]? = nil, fieldsgameCenterEnabledVersions: [FieldsgameCenterEnabledVersions]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
