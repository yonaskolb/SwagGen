...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-create_instance", tag: "AppScreenshots", method: "POST", path: "/v1/appScreenshots", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
