...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsAppScreenshotsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-appScreenshots-get_to_many_related", tag: "AppScreenshotSets", method: "GET", path: "/v1/appScreenshotSets/{id}/appScreenshots", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppScreenshotsResponse, ErrorResponse> {
