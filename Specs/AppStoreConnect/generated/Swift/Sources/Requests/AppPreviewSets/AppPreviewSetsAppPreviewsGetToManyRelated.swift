...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-get_to_many_related", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}/appPreviews", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppPreviewsResponse, ErrorResponse> {
