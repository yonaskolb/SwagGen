...
extension AppStoreConnect.AppPriceTiers {
    ...
    public enum AppPriceTiersPricePointsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appPriceTiers-pricePoints-get_to_many_related", tag: "AppPriceTiers", method: "GET", path: "/v1/appPriceTiers/{id}/pricePoints", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppPricePointsResponse, ErrorResponse> {
