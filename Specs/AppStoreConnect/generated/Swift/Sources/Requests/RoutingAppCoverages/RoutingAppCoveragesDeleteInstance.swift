...
extension AppStoreConnect.RoutingAppCoverages {
    ...
    public enum RoutingAppCoveragesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "routingAppCoverages-delete_instance", tag: "RoutingAppCoverages", method: "DELETE", path: "/v1/routingAppCoverages/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
