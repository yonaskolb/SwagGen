...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-create_instance", tag: "BundleIds", method: "POST", path: "/v1/bundleIds", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])

        public final class Request: APIRequest<Response> {

            public var body: BundleIdCreateRequest

            public init(body: BundleIdCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single BundleId */
            case status201(BundleIdResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(BundleIdResponse.self, from: data))
