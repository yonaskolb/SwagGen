...
extension AppStoreConnect.AppPricePoints {
    ...
    public enum AppPricePointsTerritoryGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appPricePoints-territory-get_to_one_related", tag: "AppPricePoints", method: "GET", path: "/v1/appPricePoints/{id}/territory", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<TerritoryResponse, ErrorResponse> {
