...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsIdfaDeclarationGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-idfaDeclaration-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/idfaDeclaration", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsidfaDeclarations: [FieldsidfaDeclarations]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsidfaDeclarations: [FieldsidfaDeclarations]? = nil) {
