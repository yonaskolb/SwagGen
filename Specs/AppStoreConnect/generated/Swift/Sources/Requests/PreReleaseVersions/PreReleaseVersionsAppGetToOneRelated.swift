...
extension AppStoreConnect.PreReleaseVersions {
    ...
    public enum PreReleaseVersionsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "preReleaseVersions-app-get_to_one_related", tag: "PreReleaseVersions", method: "GET", path: "/v1/preReleaseVersions/{id}/app", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
