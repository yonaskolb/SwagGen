...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesCreateInstance {
        ...
        public static let service = APIService<Response>(id: "profiles-create_instance", tag: "Profiles", method: "POST", path: "/v1/profiles", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])

        public final class Request: APIRequest<Response> {

            public var body: ProfileCreateRequest

            public init(body: ProfileCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single Profile */
            case status201(ProfileResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(ProfileResponse.self, from: data))
