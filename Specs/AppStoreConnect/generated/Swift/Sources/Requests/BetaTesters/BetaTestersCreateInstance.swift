...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersCreateInstance {
        ...
        public static let service = APIService<Response>(id: "betaTesters-create_instance", tag: "BetaTesters", method: "POST", path: "/v1/betaTesters", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])

        public final class Request: APIRequest<Response> {

            public var body: BetaTesterCreateRequest

            public init(body: BetaTesterCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single BetaTester */
            case status201(BetaTesterResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(BetaTesterResponse.self, from: data))
