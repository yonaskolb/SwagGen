...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsReplaceToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-replace_to_many_relationship", tag: "AppPreviewSets", method: "PATCH", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
