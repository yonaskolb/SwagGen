...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBetaGroupsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-betaGroups-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/betaGroups", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
