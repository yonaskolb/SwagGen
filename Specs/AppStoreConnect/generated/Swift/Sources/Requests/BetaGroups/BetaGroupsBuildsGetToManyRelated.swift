...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsBuildsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "betaGroups-builds-get_to_many_related", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups/{id}/builds", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
