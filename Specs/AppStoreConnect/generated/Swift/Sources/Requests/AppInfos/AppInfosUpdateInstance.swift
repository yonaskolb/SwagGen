...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfos-update_instance", tag: "AppInfos", method: "PATCH", path: "/v1/appInfos/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
