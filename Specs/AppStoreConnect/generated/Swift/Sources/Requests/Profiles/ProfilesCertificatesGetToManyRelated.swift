...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesCertificatesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "profiles-certificates-get_to_many_related", tag: "Profiles", method: "GET", path: "/v1/profiles/{id}/certificates", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldscertificates: [Fieldscertificates]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldscertificates: [Fieldscertificates]? = nil, limit: Int? = nil) {
