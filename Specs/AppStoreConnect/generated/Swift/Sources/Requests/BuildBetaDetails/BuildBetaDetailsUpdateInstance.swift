...
extension AppStoreConnect.BuildBetaDetails {
    ...
    public enum BuildBetaDetailsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "buildBetaDetails-update_instance", tag: "BuildBetaDetails", method: "PATCH", path: "/v1/buildBetaDetails/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BuildBetaDetailUpdateRequest

            public init(body: BuildBetaDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: BuildBetaDetailUpdateRequest) {
