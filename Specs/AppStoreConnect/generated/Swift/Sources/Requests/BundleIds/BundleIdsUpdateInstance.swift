...
extension AppStoreConnect.BundleIds {
    ...
    public enum BundleIdsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "bundleIds-update_instance", tag: "BundleIds", method: "PATCH", path: "/v1/bundleIds/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BundleIdUpdateRequest

            public init(body: BundleIdUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: BundleIdUpdateRequest) {
