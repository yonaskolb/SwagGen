...
extension AppStoreConnect.BetaAppReviewDetails {
    ...
    public enum BetaAppReviewDetailsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewDetails-get_instance", tag: "BetaAppReviewDetails", method: "GET", path: "/v1/betaAppReviewDetails/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppReviewDetails: [FieldsbetaAppReviewDetails]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaAppReviewDetails: [FieldsbetaAppReviewDetails]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
