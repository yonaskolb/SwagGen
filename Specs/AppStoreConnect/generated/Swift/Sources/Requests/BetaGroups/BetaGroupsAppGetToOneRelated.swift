...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "betaGroups-app-get_to_one_related", tag: "BetaGroups", method: "GET", path: "/v1/betaGroups/{id}/app", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
