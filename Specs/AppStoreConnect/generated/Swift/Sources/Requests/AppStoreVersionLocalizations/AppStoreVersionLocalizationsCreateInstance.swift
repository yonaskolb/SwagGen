...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-create_instance", tag: "AppStoreVersionLocalizations", method: "POST", path: "/v1/appStoreVersionLocalizations", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
