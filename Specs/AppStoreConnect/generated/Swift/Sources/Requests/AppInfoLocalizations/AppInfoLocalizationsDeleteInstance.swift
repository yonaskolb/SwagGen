...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-delete_instance", tag: "AppInfoLocalizations", method: "DELETE", path: "/v1/appInfoLocalizations/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
