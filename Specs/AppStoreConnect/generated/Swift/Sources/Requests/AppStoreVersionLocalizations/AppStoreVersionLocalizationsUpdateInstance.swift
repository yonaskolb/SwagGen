...
extension AppStoreConnect.AppStoreVersionLocalizations {
    ...
    public enum AppStoreVersionLocalizationsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersionLocalizations-update_instance", tag: "AppStoreVersionLocalizations", method: "PATCH", path: "/v1/appStoreVersionLocalizations/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: AppStoreVersionLocalizationUpdateRequest

            public init(body: AppStoreVersionLocalizationUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: AppStoreVersionLocalizationUpdateRequest) {
