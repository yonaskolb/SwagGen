...
extension Rocket.Profile {
    ...
    public enum GetBookmarks {
        ...
        public static let service = APIService<Response>(id: "getBookmarks", tag: "profile", method: "GET", path: "/account/profile/bookmarks", hasBody: false, securityRequirement: SecurityRequirement(type: "profileAuth", scopes: ["Catalog"]))
