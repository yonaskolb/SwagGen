...
extension AppStoreConnect.BetaAppLocalizations {
    ...
    public enum BetaAppLocalizationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "betaAppLocalizations-get_instance", tag: "BetaAppLocalizations", method: "GET", path: "/v1/betaAppLocalizations/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaAppLocalizations: [FieldsbetaAppLocalizations]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaAppLocalizations: [FieldsbetaAppLocalizations]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BetaAppLocalizationResponse

            /** Single BetaAppLocalization */
            case status200(BetaAppLocalizationResponse)
            ...
            public var success: BetaAppLocalizationResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BetaAppLocalizationResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BetaAppLocalizationResponse.self, from: data))
