...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsBuildsCreateToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-builds-create_to_many_relationship", tag: "AppEncryptionDeclarations", method: "POST", path: "/v1/appEncryptionDeclarations/{id}/relationships/builds", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
