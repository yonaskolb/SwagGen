...
extension AppStoreConnect.BetaGroups {
    ...
    public enum BetaGroupsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "betaGroups-create_instance", tag: "BetaGroups", method: "POST", path: "/v1/betaGroups", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])

        public final class Request: APIRequest<Response> {

            public var body: BetaGroupCreateRequest

            public init(body: BetaGroupCreateRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Single BetaGroup */
            case status201(BetaGroupResponse)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(BetaGroupResponse.self, from: data))
