...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "profiles-delete_instance", tag: "Profiles", method: "DELETE", path: "/v1/profiles/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
