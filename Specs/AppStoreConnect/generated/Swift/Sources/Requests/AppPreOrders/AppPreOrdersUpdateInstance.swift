...
extension AppStoreConnect.AppPreOrders {
    ...
    public enum AppPreOrdersUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreOrders-update_instance", tag: "AppPreOrders", method: "PATCH", path: "/v1/appPreOrders/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
