...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAgeRatingDeclarationGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-ageRatingDeclaration-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/ageRatingDeclaration", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsageRatingDeclarations: [FieldsageRatingDeclarations]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsageRatingDeclarations: [FieldsageRatingDeclarations]? = nil) {
