...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsAppEncryptionDeclarationGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "builds-appEncryptionDeclaration-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/appEncryptionDeclaration", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappEncryptionDeclarations: [FieldsappEncryptionDeclarations]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappEncryptionDeclarations: [FieldsappEncryptionDeclarations]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppEncryptionDeclarationResponse, ErrorResponse> {
