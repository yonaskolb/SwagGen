...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsBuildBetaDetailGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "builds-buildBetaDetail-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/buildBetaDetail", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuildBetaDetails: [FieldsbuildBetaDetails]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbuildBetaDetails: [FieldsbuildBetaDetails]? = nil) {
