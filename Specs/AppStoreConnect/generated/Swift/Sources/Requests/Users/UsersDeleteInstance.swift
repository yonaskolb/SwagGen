...
extension AppStoreConnect.Users {
    ...
    public enum UsersDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "users-delete_instance", tag: "Users", method: "DELETE", path: "/v1/users/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
