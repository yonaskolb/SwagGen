...
extension AppStoreConnect.Apps {
    ...
    public enum AppsBuildsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-builds-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/builds", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
