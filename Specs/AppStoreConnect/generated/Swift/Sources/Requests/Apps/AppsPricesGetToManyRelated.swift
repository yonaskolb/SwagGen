...
extension AppStoreConnect.Apps {
    ...
    public enum AppsPricesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-prices-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/prices", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappPrices: [FieldsappPrices]? = nil, fieldsappPriceTiers: [FieldsappPriceTiers]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappPrices: [FieldsappPrices]? = nil, fieldsappPriceTiers: [FieldsappPriceTiers]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppPricesResponse

            /** List of related resources */
            case status200(AppPricesResponse)
            ...
            public var success: AppPricesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppPricesResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppPricesResponse.self, from: data))
