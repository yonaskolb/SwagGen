...
extension AppStoreConnect.BetaAppReviewDetails {
    ...
    public enum BetaAppReviewDetailsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewDetails-app-get_to_one_related", tag: "BetaAppReviewDetails", method: "GET", path: "/v1/betaAppReviewDetails/{id}/app", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
