...
extension AppStoreConnect.Apps {
    ...
    public enum AppsAvailableTerritoriesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-availableTerritories-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/availableTerritories", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
