...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesDevicesGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "profiles-devices-get_to_many_related", tag: "Profiles", method: "GET", path: "/v1/profiles/{id}/devices", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsdevices: [Fieldsdevices]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsdevices: [Fieldsdevices]? = nil, limit: Int? = nil) {
