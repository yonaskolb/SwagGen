...
extension AppStoreConnect.AppPreviews {
    ...
    public enum AppPreviewsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreviews-create_instance", tag: "AppPreviews", method: "POST", path: "/v1/appPreviews", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
