...
extension AppStoreConnect.AppPreOrders {
    ...
    public enum AppPreOrdersCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appPreOrders-create_instance", tag: "AppPreOrders", method: "POST", path: "/v1/appPreOrders", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
