...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-get_instance", tag: "AppStoreReviewAttachments", method: "GET", path: "/v1/appStoreReviewAttachments/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
