...
extension TFL.StopPoint {
    ...
    public enum StopPointMetaCategories {
        ...
        public static let service = APIService<Response>(id: "StopPoint_MetaCategories", tag: "StopPoint", method: "GET", path: "/StopPoint/Meta/Categories", hasBody: false, securityRequirements: [])
