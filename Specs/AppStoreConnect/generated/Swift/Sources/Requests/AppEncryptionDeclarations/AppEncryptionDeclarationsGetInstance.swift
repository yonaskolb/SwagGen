...
extension AppStoreConnect.AppEncryptionDeclarations {
    ...
    public enum AppEncryptionDeclarationsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appEncryptionDeclarations-get_instance", tag: "AppEncryptionDeclarations", method: "GET", path: "/v1/appEncryptionDeclarations/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
