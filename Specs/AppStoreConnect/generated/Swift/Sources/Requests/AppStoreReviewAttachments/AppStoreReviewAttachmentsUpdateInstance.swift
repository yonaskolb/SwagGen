...
extension AppStoreConnect.AppStoreReviewAttachments {
    ...
    public enum AppStoreReviewAttachmentsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewAttachments-update_instance", tag: "AppStoreReviewAttachments", method: "PATCH", path: "/v1/appStoreReviewAttachments/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppStoreReviewAttachmentResponse, ErrorResponse> {
