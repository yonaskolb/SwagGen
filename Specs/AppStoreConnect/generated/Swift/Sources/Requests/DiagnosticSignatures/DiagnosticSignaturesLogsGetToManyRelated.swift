...
extension AppStoreConnect.DiagnosticSignatures {
    ...
    public enum DiagnosticSignaturesLogsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "diagnosticSignatures-logs-get_to_many_related", tag: "DiagnosticSignatures", method: "GET", path: "/v1/diagnosticSignatures/{id}/logs", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = DiagnosticLogsResponse

            /** List of related resources */
            case status200(DiagnosticLogsResponse)
            ...
            public var success: DiagnosticLogsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<DiagnosticLogsResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(DiagnosticLogsResponse.self, from: data))
