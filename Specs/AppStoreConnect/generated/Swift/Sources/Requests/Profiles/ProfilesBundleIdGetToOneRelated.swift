...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesBundleIdGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "profiles-bundleId-get_to_one_related", tag: "Profiles", method: "GET", path: "/v1/profiles/{id}/bundleId", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbundleIds: [FieldsbundleIds]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbundleIds: [FieldsbundleIds]? = nil) {
