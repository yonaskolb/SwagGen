...
__Note__: Season "0" is for all episodes that are considered to be specials. */
    public enum GetSeriesByIdEpisodesSummary {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = SeriesEpisodesSummary

            /** A summary of the episodes and seasons avaialable for the given series. */
            case status200(SeriesEpisodesSummary)
            ...
            public var success: SeriesEpisodesSummary? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(SeriesEpisodesSummary.self, from: data))
