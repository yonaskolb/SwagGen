...
extension TVDB.Series {
    ...
    public enum GetSeriesById {

        public static let service = APIService<Response>(id: "getSeriesById", tag: "Series", method: "GET", path: "/series/{id}", hasBody: false, securityRequirement: SecurityRequirement(type: "jwtToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSeriesById.service)
            }
