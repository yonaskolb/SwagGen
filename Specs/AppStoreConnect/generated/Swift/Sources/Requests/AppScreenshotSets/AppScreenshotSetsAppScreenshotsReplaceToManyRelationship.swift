...
extension AppStoreConnect.AppScreenshotSets {
    ...
    public enum AppScreenshotSetsAppScreenshotsReplaceToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appScreenshotSets-appScreenshots-replace_to_many_relationship", tag: "AppScreenshotSets", method: "PATCH", path: "/v1/appScreenshotSets/{id}/relationships/appScreenshots", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
