...
extension AppStoreConnect.Apps {
    ...
    public enum AppsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "apps-update_instance", tag: "Apps", method: "PATCH", path: "/v1/apps/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: AppUpdateRequest

            public init(body: AppUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: AppUpdateRequest) {
