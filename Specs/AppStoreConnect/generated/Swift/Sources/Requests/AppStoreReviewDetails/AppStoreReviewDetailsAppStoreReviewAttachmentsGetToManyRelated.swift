...
extension AppStoreConnect.AppStoreReviewDetails {
    ...
    public enum AppStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreReviewDetails-appStoreReviewAttachments-get_to_many_related", tag: "AppStoreReviewDetails", method: "GET", path: "/v1/appStoreReviewDetails/{id}/appStoreReviewAttachments", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppStoreReviewAttachmentsResponse, ErrorResponse> {
