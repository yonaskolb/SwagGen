...
extension Rocket.Profile {
    ...
    public enum GetItemBookmark {
        ...
        public static let service = APIService<Response>(id: "getItemBookmark", tag: "profile", method: "GET", path: "/account/profile/bookmarks/{itemId}", hasBody: false, securityRequirement: SecurityRequirement(type: "profileAuth", scopes: ["Catalog"]))
