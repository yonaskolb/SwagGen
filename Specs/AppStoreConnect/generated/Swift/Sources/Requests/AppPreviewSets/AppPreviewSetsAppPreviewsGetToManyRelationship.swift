...
extension AppStoreConnect.AppPreviewSets {
    ...
    public enum AppPreviewSetsAppPreviewsGetToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "appPreviewSets-appPreviews-get_to_many_relationship", tag: "AppPreviewSets", method: "GET", path: "/v1/appPreviewSets/{id}/relationships/appPreviews", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppPreviewSetAppPreviewsLinkagesResponse, ErrorResponse> {
