...
extension AppStoreConnect.Profiles {
    ...
    public enum ProfilesGetCollection {
        ...
        public static let service = APIService<Response>(id: "profiles-get_collection", tag: "Profiles", method: "GET", path: "/v1/profiles", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])

        /** filter by attribute 'profileState' */
        public enum FilterprofileState: String, Codable, Equatable, CaseIterable {
            case active = "ACTIVE"
            case invalid = "INVALID"
        }

        /** filter by attribute 'profileType' */
        public enum FilterprofileType: String, Codable, Equatable, CaseIterable {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(filtername: [String]? = nil, filterprofileState: [FilterprofileState]? = nil, filterprofileType: [FilterprofileType]? = nil, filterid: [String]? = nil, sort: [Sort]? = nil, fieldsprofiles: [Fieldsprofiles]? = nil, limit: Int? = nil, include: [Include]? = nil, fieldscertificates: [Fieldscertificates]? = nil, fieldsdevices: [Fieldsdevices]? = nil, fieldsbundleIds: [FieldsbundleIds]? = nil, limitcertificates: Int? = nil, limitdevices: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ProfilesResponse

            /** List of Profiles */
            case status200(ProfilesResponse)
            ...
            public var success: ProfilesResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ProfilesResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ProfilesResponse.self, from: data))
