...
extension AppStoreConnect.Certificates {
    ...
    public enum CertificatesGetInstance {
        ...
        public static let service = APIService<Response>(id: "certificates-get_instance", tag: "Certificates", method: "GET", path: "/v1/certificates/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldscertificates: [Fieldscertificates]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldscertificates: [Fieldscertificates]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = CertificateResponse

            /** Single Certificate */
            case status200(CertificateResponse)
            ...
            public var success: CertificateResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<CertificateResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(CertificateResponse.self, from: data))
