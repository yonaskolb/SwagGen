...
extension AppStoreConnect.Apps {
    ...
    public enum AppsAppInfosGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "apps-appInfos-get_to_many_related", tag: "Apps", method: "GET", path: "/v1/apps/{id}/appInfos", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappInfos: [FieldsappInfos]? = nil, fieldsappCategories: [FieldsappCategories]? = nil, fieldsappInfoLocalizations: [FieldsappInfoLocalizations]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappInfos: [FieldsappInfos]? = nil, fieldsappCategories: [FieldsappCategories]? = nil, fieldsappInfoLocalizations: [FieldsappInfoLocalizations]? = nil, fieldsapps: [Fieldsapps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppInfosResponse

            /** List of related resources */
            case status200(AppInfosResponse)
            ...
            public var success: AppInfosResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppInfosResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppInfosResponse.self, from: data))
