...
extension AppStoreConnect.BetaAppReviewDetails {
    ...
    public enum BetaAppReviewDetailsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewDetails-update_instance", tag: "BetaAppReviewDetails", method: "PATCH", path: "/v1/betaAppReviewDetails/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BetaAppReviewDetailUpdateRequest

            public init(body: BetaAppReviewDetailUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: BetaAppReviewDetailUpdateRequest) {
