...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsAppStoreVersionSubmissionGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-appStoreVersionSubmission-get_to_one_related", tag: "AppStoreVersions", method: "GET", path: "/v1/appStoreVersions/{id}/appStoreVersionSubmission", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsappStoreVersions: [FieldsappStoreVersions]? = nil, fieldsappStoreVersionSubmissions: [FieldsappStoreVersionSubmissions]? = nil, include: [Include]? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsappStoreVersions: [FieldsappStoreVersions]? = nil, fieldsappStoreVersionSubmissions: [FieldsappStoreVersionSubmissions]? = nil, include: [Include]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppStoreVersionSubmissionResponse

            /** Related resource */
            case status200(AppStoreVersionSubmissionResponse)
            ...
            public var success: AppStoreVersionSubmissionResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppStoreVersionSubmissionResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppStoreVersionSubmissionResponse.self, from: data))
