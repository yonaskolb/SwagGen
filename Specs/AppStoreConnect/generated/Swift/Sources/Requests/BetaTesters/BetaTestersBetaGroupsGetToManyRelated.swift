...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBetaGroupsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "betaTesters-betaGroups-get_to_many_related", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters/{id}/betaGroups", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbetaGroups: [FieldsbetaGroups]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbetaGroups: [FieldsbetaGroups]? = nil, limit: Int? = nil) {
