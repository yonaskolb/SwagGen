...
extension AppStoreConnect.BetaLicenseAgreements {
    ...
    public enum BetaLicenseAgreementsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "betaLicenseAgreements-update_instance", tag: "BetaLicenseAgreements", method: "PATCH", path: "/v1/betaLicenseAgreements/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BetaLicenseAgreementUpdateRequest

            public init(body: BetaLicenseAgreementUpdateRequest, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(id: String, body: BetaLicenseAgreementUpdateRequest) {
