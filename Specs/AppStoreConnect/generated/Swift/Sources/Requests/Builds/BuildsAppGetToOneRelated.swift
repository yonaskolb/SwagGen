...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsAppGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "builds-app-get_to_one_related", tag: "Builds", method: "GET", path: "/v1/builds/{id}/app", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
