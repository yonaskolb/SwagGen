...
extension TVDB.Users {
    ...
    public enum GetUser {
        ...
        public static let service = APIService<Response>(id: "getUser", tag: "Users", method: "GET", path: "/user", hasBody: false, securityRequirement: SecurityRequirement(type: "jwtToken", scopes: []))
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = UserData

            /** User information. */
            case status200(UserData)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(UserData.self, from: data))
