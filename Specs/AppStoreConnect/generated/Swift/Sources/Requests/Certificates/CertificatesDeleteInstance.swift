...
extension AppStoreConnect.Certificates {
    ...
    public enum CertificatesDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "certificates-delete_instance", tag: "Certificates", method: "DELETE", path: "/v1/certificates/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
