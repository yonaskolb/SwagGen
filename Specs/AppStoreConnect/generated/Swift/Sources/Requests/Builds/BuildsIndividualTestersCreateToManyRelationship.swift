...
extension AppStoreConnect.Builds {
    ...
    public enum BuildsIndividualTestersCreateToManyRelationship {
        ...
        public static let service = APIService<Response>(id: "builds-individualTesters-create_to_many_relationship", tag: "Builds", method: "POST", path: "/v1/builds/{id}/relationships/individualTesters", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
