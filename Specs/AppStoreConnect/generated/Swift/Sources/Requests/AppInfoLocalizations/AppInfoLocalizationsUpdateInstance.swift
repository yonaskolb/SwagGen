...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-update_instance", tag: "AppInfoLocalizations", method: "PATCH", path: "/v1/appInfoLocalizations/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppInfoLocalizationResponse, ErrorResponse> {
