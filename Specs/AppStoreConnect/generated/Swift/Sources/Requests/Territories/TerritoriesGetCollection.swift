...
extension AppStoreConnect.Territories {
    ...
    public enum TerritoriesGetCollection {
        ...
        public static let service = APIService<Response>(id: "territories-get_collection", tag: "Territories", method: "GET", path: "/v1/territories", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(fieldsterritories: [Fieldsterritories]? = nil, limit: Int? = nil) {
            ...
            public convenience init(fieldsterritories: [Fieldsterritories]? = nil, limit: Int? = nil) {
