...
extension AppStoreConnect.AppStoreVersions {
    ...
    public enum AppStoreVersionsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "appStoreVersions-delete_instance", tag: "AppStoreVersions", method: "DELETE", path: "/v1/appStoreVersions/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
