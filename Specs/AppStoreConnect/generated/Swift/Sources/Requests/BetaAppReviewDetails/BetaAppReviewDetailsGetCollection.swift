...
extension AppStoreConnect.BetaAppReviewDetails {
    ...
    public enum BetaAppReviewDetailsGetCollection {
        ...
        public static let service = APIService<Response>(id: "betaAppReviewDetails-get_collection", tag: "BetaAppReviewDetails", method: "GET", path: "/v1/betaAppReviewDetails", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(filterapp: [String], fieldsbetaAppReviewDetails: [FieldsbetaAppReviewDetails]? = nil, limit: Int? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BetaAppReviewDetailsResponse

            /** List of BetaAppReviewDetails */
            case status200(BetaAppReviewDetailsResponse)
            ...
            public var success: BetaAppReviewDetailsResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BetaAppReviewDetailsResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BetaAppReviewDetailsResponse.self, from: data))
