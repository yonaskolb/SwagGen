...
extension AppStoreConnect.EndUserLicenseAgreements {
    ...
    public enum EndUserLicenseAgreementsDeleteInstance {
        ...
        public static let service = APIService<Response>(id: "endUserLicenseAgreements-delete_instance", tag: "EndUserLicenseAgreements", method: "DELETE", path: "/v1/endUserLicenseAgreements/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
