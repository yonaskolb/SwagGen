...
extension AppStoreConnect.BetaTesters {
    ...
    public enum BetaTestersBuildsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "betaTesters-builds-get_to_many_related", tag: "BetaTesters", method: "GET", path: "/v1/betaTesters/{id}/builds", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
