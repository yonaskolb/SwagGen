...
extension Rocket.Account {
    ...
    public enum ChangePassword {
        ...
        public static let service = APIService<Response>(id: "changePassword", tag: "account", method: "PUT", path: "/account/password", hasBody: true, securityRequirements: [SecurityRequirement(type: "accountAuth", isRequired: true, scopes: ["Settings"])])
