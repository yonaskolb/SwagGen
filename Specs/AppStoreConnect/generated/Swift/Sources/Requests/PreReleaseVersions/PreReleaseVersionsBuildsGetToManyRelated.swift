...
extension AppStoreConnect.PreReleaseVersions {
    ...
    public enum PreReleaseVersionsBuildsGetToManyRelated {
        ...
        public static let service = APIService<Response>(id: "preReleaseVersions-builds-get_to_many_related", tag: "PreReleaseVersions", method: "GET", path: "/v1/preReleaseVersions/{id}/builds", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsbuilds: [Fieldsbuilds]? = nil, limit: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsbuilds: [Fieldsbuilds]? = nil, limit: Int? = nil) {
