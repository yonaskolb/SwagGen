...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsGetInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-get_instance", tag: "AppScreenshots", method: "GET", path: "/v1/appScreenshots/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
