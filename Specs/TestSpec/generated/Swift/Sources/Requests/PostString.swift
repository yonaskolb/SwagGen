...
extension TestSpec {
    ...
    public enum PostString {
        ...
        public static let service = APIService<Response>(id: "postString", tag: "", method: "POST", path: "/string", hasBody: true, securityRequirements: [SecurityRequirement(type: "test_auth", isRequired: true, scopes: ["read"])])
