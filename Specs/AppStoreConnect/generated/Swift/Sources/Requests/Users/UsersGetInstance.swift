...
extension AppStoreConnect.Users {
    ...
    public enum UsersGetInstance {
        ...
        public static let service = APIService<Response>(id: "users-get_instance", tag: "Users", method: "GET", path: "/v1/users/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(id: String, fieldsusers: [Fieldsusers]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil, limitvisibleApps: Int? = nil) {
                    self.id = id
            ...
            public convenience init(id: String, fieldsusers: [Fieldsusers]? = nil, include: [Include]? = nil, fieldsapps: [Fieldsapps]? = nil, limitvisibleApps: Int? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = UserResponse

            /** Single User */
            case status200(UserResponse)
            ...
            public var success: UserResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<UserResponse, ErrorResponse> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(UserResponse.self, from: data))
