...
extension AppStoreConnect.AppInfos {
    ...
    public enum AppInfosSecondarySubcategoryOneGetToOneRelated {
        ...
        public static let service = APIService<Response>(id: "appInfos-secondarySubcategoryOne-get_to_one_related", tag: "AppInfos", method: "GET", path: "/v1/appInfos/{id}/secondarySubcategoryOne", hasBody: false, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
