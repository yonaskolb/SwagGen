...
extension AppStoreConnect.AppInfoLocalizations {
    ...
    public enum AppInfoLocalizationsCreateInstance {
        ...
        public static let service = APIService<Response>(id: "appInfoLocalizations-create_instance", tag: "AppInfoLocalizations", method: "POST", path: "/v1/appInfoLocalizations", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
