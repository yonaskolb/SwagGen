...
extension AppStoreConnect.AppScreenshots {
    ...
    public enum AppScreenshotsUpdateInstance {
        ...
        public static let service = APIService<Response>(id: "appScreenshots-update_instance", tag: "AppScreenshots", method: "PATCH", path: "/v1/appScreenshots/{id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "itc-bearer-token", scopes: [])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<AppScreenshotResponse, ErrorResponse> {
