 ...
 */
    public enum ResetPassword {
        ...
        public static let service = APIService<Response>(id: "resetPassword", tag: "support", method: "POST", path: "/reset-password", hasBody: true, securityRequirements: [SecurityRequirement(type: "resetPasswordAuth", isRequired: true, scopes: [])])
